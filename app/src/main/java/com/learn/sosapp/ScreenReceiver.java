            ...
            fusedLocationProviderClient.getLastLocation().addOnSuccessListener(location -> {
                if (location != null) {
                    ...
                    try {
                        ...
                        sms.sendTextMessage(contact1, null, "I am in Danger, HELP ME!!\n My Current Location is:\n" + " " + cityName + " " + stateName + " " + countryName, null, null);
                        sms.sendTextMessage(contact2, null, "I am in Danger, HELP ME!!\n My Current Location is:\n"+cityName+" "+stateName+" "+countryName , null,null);
                        sms.sendTextMessage(contact3, null, "I am in Danger, HELP ME!!\n My Current Location is:\n"+cityName+" "+stateName+" "+countryName , null,null);
                    } catch (Exception e) {
                        Log.d(TAG, "Exception occured -> " + e, e);
                    }
//                    Toast.makeText(fusedLocationProviderClient.(), "cityname: " + cityName + " stateName: " + stateName + " countryName: " + countryName, Toast.LENGTH_SHORT).show();
                } else {
